...
[bit-playground browser app](https://abourdim.github.io/bit-playground/) —
...
2. **Advanced → Extensions → search** `abourdim/bit-playground-companion`
...
declares it, `main.ts` is the example, `bit-playground.ts` is the block
